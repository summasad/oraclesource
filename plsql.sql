...
-- 커서(cursor) : SELECT 문 또는 DML 과 같은 SQL 구문 실행했을 때 해당 SQL을 처리하는
-- 정보를 저장한 메모리 공간
...
--트리거 생성
--RAISE_APPLICATION_ERROR(오류코드번호, 메세지) : EXCEPTION (==THROW)
...
CREATE TABLE EMP_TRG_LOG(
	TABLENAME VARCHAR2(10), --DML 이 수행된 테이블명
...
INSERT INTO EMP_TRG
VALUES(9999,'TESTMP','CLERK',7788,'2018-02-02',1200,NULL,20);
